...
class _TestInfo(object):
    ...
    def __init__(self, test_result, test_method, outcome=SUCCESS,
        ...
        if not self.is_subtest:
            ...
            # self.stream.writeln("123 Test ID: {}".format(self.test_id))
        else:
            self.test_id = subTest.id()
            # self.stream.writeln("345 SubTest ID: {}".format(self.test_id))
...
class HtmlTestResult(TextTestResult):
    ...
    def addSubTest(self, testcase, test, err):
        ...
        self.stream.writeln("test_id_components[1]: {}".format(test_id_components[1]))
        self.stream.writeln("test_id_components[0]: {}".format(test_id_components[0]))
